...
//
class GenericDCD : public BaseCollision
{
public:
    GenericDCD(real alarm_distance, real minimum_separation, bool VF, bool EE, bool FV):
    ...
    void detect_impl(std::vector<RealSim::contact::ContactPair> &output, const MatX3R &pos0, real /*dt*/) ; // add BVH for collide
    void detect_parallel_impl(std::vector<RealSim::contact::ContactPair> &output, const MatX3R &pos0, real /*dt*/) ; // add boardphrase for multi-objects
...
public:
    DCDVFDetectionInRange(std::vector<RealSim::contact::ContactPair> &_output,
                       const MatX3R &_pi_t0,
                       const MatX3R &_pj_t0,
                       const VecXI *_vset,
                       const MatX3I *_fset,
...
public:
    DCDEEDetectionInRange(std::vector<RealSim::contact::ContactPair> &_output,
                       const MatX3R &_pi_t0,
                       const MatX3R &_pj_t0,
                       const MatX2I *_eset0,
                       const MatX2I *_eset1,
