...
if __name__ == '__main__':
    ...
    def simulate(x, vis_folder):
        ...
        loss, _ = env.simulate(dt, frame_num, method, opt, q0, v0, act, f0, require_grad=False, vis_folder=vis_folder)
    ...
    simulate(x_random, 'random_render')
    ...
    generate_mesh('random_render', 'random_mesh', x_random)
